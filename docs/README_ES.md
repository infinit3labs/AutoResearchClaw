...
# 3. Configurar
poetry run researchclaw init          # Interactivo: elegir proveedor LLM, crea config.arc.yaml
...
5. Ejecuta `poetry install` + `poetry run researchclaw run --topic "..." --auto-approve`
