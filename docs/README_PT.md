...
# 3. Configure
poetry run researchclaw init          # Interativo: escolha provedor LLM, cria config.arc.yaml
...
5. Executa `poetry install` + `poetry run researchclaw run --topic "..." --auto-approve`
