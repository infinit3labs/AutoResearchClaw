...
# 3. Configurer
poetry run researchclaw init          # Interactif : choisir le fournisseur LLM, cree config.arc.yaml
...
5. Execute `poetry install` + `poetry run researchclaw run --topic "..." --auto-approve`
